...
var hud_big_label_settings = preload("res://resources/UI/hud_big_label_settings.tres")
...
func apply(value: Variant) -> void:
	if value:
		...
		hud_big_label_settings.font = custom_font
		help_label_settings.font = custom_font
	else:
		hud_label_settings.font = null
		hud2_label_settings.font = null
		hud_big_label_settings.font = null
